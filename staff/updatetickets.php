...
<div  class="panel-heading">
  <a href=index.php?page=addtickets ><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg>add new tickets</a>
</div>
		...
		<div style="background-color :transparent" class="row">
			<div class="col-lg-12">
				<div style="background-color :transparent"class="panel panel-default">
                  ...
                  <thead>
							    <tr>
							    	<th width="80">Tickets ID</th>
							    	<th width="80">Ticket Name</th>
						...
						<form method="POST" action="index.php">
							...
							<a href=index.php?page=updatetickets1&ID=<?php echo $row["saman_id"]; ?> ><center><button class="button button5">Update</button></center></a>
              <a href=index.php?page=deleteticketsDB&ID=<?php echo $row["saman_id"]; ?> onclick="return confirm('Are you sure to delete?')"><center><button class="button button5">Delete</button></center></a>
