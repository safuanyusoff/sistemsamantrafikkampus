				...
				<div  class="panel panel-default" style="background-color :transparent">
					...
					<div class="panel-body">
						<form  class="form-horizontal" action="index.php" method="post">
									<input type="hidden" name="page" value="updateticketsDB">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input type="text" name="name"  value="<?php echo $row['saman_name']; ?>" placeholder='Bawa Laju' class="form-control" required> 
									</div>
									</div>			
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input type="text" name="price"  value="<?php echo $row['saman_price']; ?>" placeholder='RM 50.00' class="form-control" required> 
									</div>
									</div>
